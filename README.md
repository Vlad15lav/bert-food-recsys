...
Оценка новой модели на реальных пользователях. Ссылка на [ноутбук](notebooks/ab_testing.ipynb) с вычислениями.
...
**Результат:** Эмбеддинги, полученные с помощью модели BERT, статистически значимо лучше, чем вектора статистического подхода TF-IDF!
